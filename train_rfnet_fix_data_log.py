...
parser.add_argument('--name', type=str, default='rfnet_log', help='A name to attach to the training session')
...
callbacks = get_nyu_callbacks(parallel_model, train_generator, val_generator, runPath,
                              totaL_epochs=args.epochs, warmup_epoch=5, batch_size=args.bs, lr=args.lr,val_loss="val_loss_sirmse_log")
