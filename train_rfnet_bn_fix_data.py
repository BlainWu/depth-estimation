...
from model_rfnet_add_bn import RFDN
...
parser.add_argument('--data_path', default='/home/share/competition/depth_train', type=str, help='Training dataset.')
parser.add_argument('--lr', type=float, default=0.002, help='Learning rate')
parser.add_argument('--bs', type=int, default=64, help='Batch size')
parser.add_argument('--epochs', type=int, default=100, help='Number of epochs')
parser.add_argument('--gpuids', type=str, default="0,3", help='IDs of GPUs to use')
...
parser.add_argument('--name', type=str, default='rfnet_bn_Norm1', help='A name to attach to the training session')
...
def loss_sirmse_baseline(truth, pred, mindepth=args.mindepth, maxdepth=args.maxdepth):
    max_thresh = tf.constant(maxdepth, dtype=tf.float32)
